...
func GenerateDotCodeMbr(mbr *Types.MBR, diskFileName string) string {
	...
	for _, partition := range mbr.Partitions {
		...
		if string(partition.Type[:]) == "P" || string(partition.Type[:]) == "E" {
			...
			builder.WriteString("    </TR>\n")
			builder.WriteString("    <TR>")
			builder.WriteString("    <TD BGCOLOR=\"#FFFFFF\">part_size:</TD>")
			builder.WriteString("    <TD BGCOLOR=\"#FFFFFF\">" + strconv.Itoa(int(partition.Size)) + "</TD>")
			builder.WriteString("    </TR>\n")
			builder.WriteString("    <TR>")
	...
	if logicalPartitions != nil {
		...
		for currentEBR != nil {
			...
			builder.WriteString("    <TR>")
			builder.WriteString("    <TD BGCOLOR=\"#f08080\" COLSPAN=\"2\"><FONT COLOR=\"white\">Particion Logica</FONT></TD>")
			builder.WriteString("    </TR>\n")
			...
			builder.WriteString("    </TR>\n")
			builder.WriteString("    <TR>")
			builder.WriteString("    <TD BGCOLOR=\"#f5b7b1\">part_next:</TD>")
			builder.WriteString("    <TD BGCOLOR=\"#f5b7b1\">" + partNextStr + "</TD>")
			builder.WriteString("    </TR>\n")
			builder.WriteString("    <TR>")
			builder.WriteString("    <TD BGCOLOR=\"#FFFFFF\">part_fit:</TD>")
			...
			builder.WriteString("    </TR>\n")
			builder.WriteString("    <TR>")
			builder.WriteString("    <TD BGCOLOR=\"#f5b7b1\">part_start:</TD>")
			builder.WriteString("    <TD BGCOLOR=\"#f5b7b1\">" + strconv.Itoa(int(currentEBR.PartStart)) + "</TD>")
			builder.WriteString("    </TR>\n")
			builder.WriteString("    <TR>")
			builder.WriteString("    <TD BGCOLOR=\"#ffffff\">part_size:</TD>")
			builder.WriteString("    <TD BGCOLOR=\"#ffffff\">" + strconv.Itoa(int(currentEBR.PartSize)) + "</TD>")
			builder.WriteString("    </TR>\n")
			builder.WriteString("    <TR>")
			builder.WriteString("    <TD BGCOLOR=\"#f5b7b1\">part_name:</TD>")
			builder.WriteString("    <TD BGCOLOR=\"#f5b7b1\">" + partitionName + "</TD>")
			builder.WriteString("    </TR>\n")
	...
	if logicalPartitions != nil {
		...
		for currentEBR != nil {
			...
			builder.WriteString("    <TR>")
			builder.WriteString("    <TD BGCOLOR=\"#E8DAEF\">part_type:</TD>")
			builder.WriteString("    <TD BGCOLOR=\"#E8DAEF\">L</TD>")
			builder.WriteString("    </TR>\n")
			builder.WriteString("    <TR>")
			builder.WriteString("    <TD BGCOLOR=\"#FFFFFF\">part_fit:</TD>")
			builder.WriteString("    <TD BGCOLOR=\"#FFFFFF\">" + string(currentEBR.PartFit[:]) + "</TD>")
